...
public abstract class AiPlayer extends Player {
  ...
  public HashMap<JLabel, Card> phm;
   ...
   * 
   * @param ol  ArrayList με τις jlabels που αντιστοιχουν στις εκαστοτε ανοιχτες
   *            cards.
   ...
   * @return JLabel - Την jlabel που αντιστοιχει στο ζευγαρι της εκαστοτε ανοιχτης
   *         καρτας αν εχει αποθηκευτει ή null αν δεν εχει.
   */
   ...
   * Επιστρεφει ArrayList με καρτες αν βρεθουν ολες ή null αν δεν βρεθει εστω και
   * μια.
   * 
   * @param l     JLabel για την καρτα της οποιας αναζητουνται ισες.
   * @param hm    HashMap με ολα τα ζευγαρια jlabel-card.
   * @param limit Ακεραιος που αν ειναι ισος με 3 δηλωνει τριο ή αν ειναι 4
   *              κουαρτετο.
   * @return ArrayList<JLabel> - Την ArrayList με 2 για τριο ή 3 για κουαρτετο
   *         ισες καρτες με αυτην της jlabel l, αλλιως null.
   */
